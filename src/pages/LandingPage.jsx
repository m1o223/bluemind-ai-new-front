    ...
    <nav className="w-full px-4 sm:px-6 md:px-12 lg:px-20 py-4 sm:py-5 flex items-center justify-between relative" data-testid="landing-navbar">
      <div className="flex items-center gap-2 min-w-0">
        <BrandLogo
          ...
          textClassName="text-lg sm:text-xl text-[#111827]"
        />
      </div>

      {/* Desktop nav */}
      <div className="hidden md:flex items-center gap-8">
        <a href="#features" className="text-[#6B7280] hover:text-[#111827] transition-colors text-sm font-medium">{t("features")}</a>
      </div>
      ...
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="flex-1 p-5 sm:p-6 md:p-8">
          ...
          <div className="flex items-center gap-2 sm:gap-3 border border-[#E5E7EB] rounded-full px-4 sm:px-5 py-3 md:py-3.5 mb-5 sm:mb-6 md:mb-7">
            <span className="text-[#9CA3AF] text-sm md:text-base flex-1 truncate">{t("askAnything")}</span>
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4">
            <div className="bg-[#F5F7FA] border border-[#E5E7EB] rounded-xl p-2.5 sm:p-3 md:p-4 text-center">
              ...
              <p className="text-[11px] sm:text-xs md:text-sm font-semibold text-[#111827] break-words">{t("aiChat")}</p>
              <p className="text-[9px] sm:text-[10px] md:text-xs text-[#6B7280] mt-0.5 sm:mt-1 break-words">{t("aiChatShort")}</p>
            </div>
            <div className="bg-[#F5F7FA] border border-[#E5E7EB] rounded-xl p-2.5 sm:p-3 md:p-4 text-center">
              <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-11 md:h-11 rounded-lg bg-white border border-[#E5E7EB] flex items-center justify-center mx-auto mb-2 md:mb-3">
                <Play className="w-4 h-4 sm:w-5 sm:h-5 md:w-[22px] md:h-[22px] text-[#193B68]" />
              </div>
              <p className="text-[11px] sm:text-xs md:text-sm font-semibold text-[#111827] break-words">{t("aiLearning")}</p>
              <p className="text-[9px] sm:text-[10px] md:text-xs text-[#6B7280] mt-0.5 sm:mt-1 break-words">{t("aiLearningShort")}</p>
            </div>
            <div className="bg-[#F5F7FA] border border-[#E5E7EB] rounded-xl p-2.5 sm:p-3 md:p-4 text-center">
              <div className="w-9 h-9 sm:w-10 sm:h-10 md:w-11 md:h-11 rounded-lg bg-white border border-[#E5E7EB] flex items-center justify-center mx-auto mb-2 md:mb-3">
                <Bell className="w-4 h-4 sm:w-5 sm:h-5 md:w-[22px] md:h-[22px] text-[#193B68]" />
              </div>
              <p className="text-[11px] sm:text-xs md:text-sm font-semibold text-[#111827] break-words">{t("reminders")}</p>
              <p className="text-[9px] sm:text-[10px] md:text-xs text-[#6B7280] mt-0.5 sm:mt-1 break-words">{t("smartRemindersShort")}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section ref={ref} id="features" className="landing-section px-4 sm:px-6 md:px-12 lg:px-20 py-16 sm:py-20 md:py-24 bg-white" data-testid="features-section">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-10 sm:mb-14 md:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#111827] mb-3 sm:mb-4 break-words">{t("featuresTitle")}</h2>
          <p className="text-[#6B7280] text-base sm:text-lg break-words">{t("featuresSubtitle")}</p>
        </div>
...
function HowItWorksSection() {
  ...
  return (
    <section ref={ref} id="how-it-works" className="landing-section px-4 sm:px-6 md:px-12 lg:px-20 py-16 sm:py-20 md:py-24 bg-[#F9FAFB]" data-testid="how-it-works-section">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-10 sm:mb-14 md:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#111827] mb-3 sm:mb-4 break-words">{t("howItWorks")}</h2>
          <p className="text-[#6B7280] text-base sm:text-lg">{t("howItWorksSubtitle")}</p>
        </div>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-[#F5F7FA] border border-[#E5E7EB] rounded-2xl px-6 sm:px-8 md:px-14 py-8 sm:py-10 md:py-12 flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-8">
          <div className="flex flex-col sm:flex-row items-center sm:items-center gap-4 sm:gap-5 text-center sm:text-left">
            ...
            <div>
              <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-[#111827] break-words">{t("bottomCtaTitle")}</h3>
              <p className="text-[#6B7280] text-sm mt-1.5 break-words">{t("bottomCtaSubtitle")}</p>
            </div>
          </div>
          <button
            onClick={() => navigate("/auth/register")}
